    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='F:/face_detection/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"F:\face_detection\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"F:\face_detection\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Nihar' :
            if password == 'Niharsoni@7215':
                ...
                cs = 'F:/face_detection/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
